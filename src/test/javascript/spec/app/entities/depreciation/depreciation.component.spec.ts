...
import { DepreciationComponent } from 'app/entities/depreciation/depreciation.component';
...
describe('Component Tests', () => {
    describe('Depreciation Management Component', () => {
        let comp: DepreciationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DepreciationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.depreciations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
